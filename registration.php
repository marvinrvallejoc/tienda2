    ...
    <section id="form-registration">
        <div class="container">
            <div class="page-header">
              <h1>REGISTRO <small class="tittles-pages-logo">Variedades DANNA</small></h1>
            </div>
            ...
            <div class="row">
                <div class="col-sm-5 text-center">
                    <figure>
                      <img src="./assets/img/img-auriculares.png" alt="store" class="img-responsive">
                    </figure>
                </div>
                <div class="col-sm-7">
                    <div id="container-form">
                       ...
                       <form class="FormCatElec" action="process/regclien.php" role="form" method="POST" data-form="save">
                          ...
                          <p><button type="submit" class="btn btn-info btn-block btn-raised">Registrarse</button></p>
                        </form> 
                    </div> 
                </div>
            </div>
